...
<form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
    ...
    <input type="submit" name="filmgenrerelationsubmit"
           value="Salvesta filmiinfo"><span><?php echo $studionotice; ?></span>
</form>
...
<form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
    ...
    <input type="submit" name="filmgenrerelationsubmit"
           value="Salvesta filmiinfo"><span><?php echo $genrenotice; ?></span>
</form>
